    ...
    fetch("/get-calculation-list")
        ...
        .then(function (calculations) {
            ...
            calculations.forEach(function (calculation) {
                ...
                <td><img src="/icons/edit_fill.svg" alt="" onclick="" title="Edit"><img src="/icons/info_fill.svg" alt="" onclick="" title="Info"><img src="/icons/del_table.svg" alt="" onclick="deleteProjectCalculation(${calculation.id})" title="Delete"></td>
                </tr>
                `
